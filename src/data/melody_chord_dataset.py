"""
Shared Melody-Chord paired dataset for VAE training.

Loads preprocessed .npz files produced by either the Wikifonia or Lakh
pipeline. Each sample is a fixed-length window of (melody_chroma, chord_ids) pairs.
"""
